...
contract xneogeChef {
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 stakedSupply = xneoge.balanceOf(address(this));
    ...
    function updatePool() public {
        ...
        uint256 xneogeSupply = xneoge.balanceOf(address(this));
        if (xneogeSupply == 0) {
        ...
        poolInfo.accRewardPerShare = poolInfo.accRewardPerShare.add(tokenReward.mul(1e12).div(xneogeSupply));
        poolInfo.lastRewardBlock = block.number;
    }
    ...
    function deposit(uint256 _amount) public {
        ...
        updatePool();
        xneoge.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        updatePool();
        xneoge.safeTransfer(address(msg.sender), _amount);
    ...
    function emergencyWithdraw() public {
        UserInfo storage user = userInfo[msg.sender];
        xneoge.safeTransfer(address(msg.sender), user.amount);
